...
export default function Exact2vfDHomeLive(){
 ...
 return <div className="wdcc-app wdcc-live-polish">
  <style>{`
    ...
    .wdcc-live-polish .btn-outline{color:#fff!important;background:#0b1a27!important;border-color:#526a7f!important;box-shadow:0 12px 28px #0008!important}
    ...
    .wdcc-live-polish .vehicle-photo-pending{position:absolute;inset:0;display:grid;place-items:center;align-content:center;gap:8px;background:radial-gradient(circle at 50% 45%,#17334a 0,#091722 48%,#050b11 100%);color:#aebdca;font-size:9px;font-weight:900;letter-spacing:.13em;text-transform:uppercase}
    .wdcc-live-polish .vehicle-photo-pending img{width:94px!important;height:94px!important;object-fit:contain!important;filter:drop-shadow(0 10px 22px #0009)!important}
    ...
    @media(max-width:760px){
      ...
      .wdcc-live-polish .site-header{height:82px!important;min-height:82px!important;padding:0 14px!important;display:grid!important;grid-template-columns:90px minmax(0,1fr) 54px!important;align-items:center!important}
      .wdcc-live-polish .mobile-menu,.wdcc-live-polish .mobile-call{display:grid!important;width:46px!important;height:46px!important}
      .wdcc-live-polish .logo-button{width:88px!important;height:82px!important;min-width:0!important;min-height:0!important;justify-self:start!important}
      .wdcc-live-polish .logo-button .brand-logo{width:88px!important;height:82px!important}
      .wdcc-live-polish .logo-button img{width:86px!important;height:86px!important;max-width:100%!important;transform:none!important}
      .wdcc-live-polish .main-nav{top:82px!important}
      .wdcc-live-polish .hero{min-height:0!important;padding:286px 18px 34px!important;background-position:center center!important}
      .wdcc-live-polish .hero-copy{padding:20px 0 8px!important;max-width:100%!important}
      .wdcc-live-polish .hero-kicker{font-size:10.5px!important;letter-spacing:1.05px!important;line-height:1.2!important;margin-bottom:11px!important}
      .wdcc-live-polish .hero-copy h1{max-width:none!important;font-size:clamp(39px,10.8vw,47px)!important;line-height:.9!important;letter-spacing:-1.55px!important;margin:0 0 16px!important}
      .wdcc-live-polish .hero-lead{font-size:14px!important;line-height:1.45!important;margin:0 0 19px!important;max-width:350px!important}
      ...
      .wdcc-live-polish .mobile-action-bar{display:grid!important}
      body:has(.wdcc-live-polish){padding-bottom:78px!important}
