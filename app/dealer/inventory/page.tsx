...
export default function DealerInventory(){
  ...
  return <main className="refDealerShell">
    <aside className="refDealerSide">
      ...
      <nav><Link href="/dealer">Dashboard</Link><div className="refDealerLabel">INVENTORY</div><Link className="active" href="/dealer/inventory">All Vehicles</Link><Link href="/dealer/inventory/new">＋ Add / Edit Vehicle</Link><Link href="/dealer/inventory">Categories</Link><Link href="/dealer/inventory">Import Vehicles</Link><div className="refDealerLabel">OPERATIONS</div><Link href="/dealer/leads">Leads</Link><Link href="/dealer/leads?view=appointments">Appointments</Link><Link href="/dealer/leads?view=appointments">Test Drives</Link><Link href="/dealer/leads">Customers</Link><Link href="/dealer/leads">Applications</Link><Link href="/dealer/leads">Messages</Link><Link href="/dealer/inventory/logs">Reports</Link><Link href="/dealer">Settings</Link></nav>
