...
export default function VehicleLogs(){
  ...
  return <main className="crmShell"><aside className="crmSidebar"><Link className="crmLogo" href="/dealer"><img src="/wdcc-official-logo.webp" alt="WDCC"/><span>SALES COMMAND</span></Link><nav><Link href="/dealer">Today</Link><Link href="/dealer/leads">Leads</Link><Link href="/dealer/inventory">Inventory</Link><Link href="/dealer/inventory/new">+ Add Vehicle</Link><Link className="active" href="/dealer/inventory/logs">Vehicle Logs</Link><a href="https://wedontcarecars.com/">View Website</a></nav></aside><section className="crmMain">
