...
export default function DealerDashboard(){
  ...
  return <main className="targetDealerApp">
    <header className="targetDealerTop"><div className="targetDealerTopBrand"><img src="/wdcc-logo-transparent.webp" alt="WDCC"/><div><b>WDCC · DEALER PORTAL</b><span>Inventory Operations</span></div></div><a href="tel:18135164752">☎ (813) 516-4752</a><span>Sean · Sales Manager</span><button onClick={logout}>Sign Out</button></header>
    <div className="targetDealerFrame">
      <aside className="targetDealerSide"><Link className="sideBrand" href="/dealer"><img src="/wdcc-logo-transparent.webp" alt=""/><span>WDCC</span></Link><nav><Link className="active" href="/dealer">⌂ Dashboard</Link><Link href="/dealer/inventory">▣ Inventory</Link><Link href="/dealer/leads">♙ Leads</Link><Link href="/dealer/leads?view=appointments">▣ Appointments</Link><Link href="/dealer/leads">◎ Customers</Link><Link href="/dealer/leads">✉ Messages</Link><Link href="/dealer/inventory/logs">▥ Reports</Link><Link href="/dealer">⚙ Settings</Link></nav></aside>
