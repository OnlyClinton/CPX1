 ...
 return <main className="reference-home locked-storefront owner-target-home">
   ...
   <section className="rh-hero">
     ...
     <div className="rh-hero-inner"><div className="rh-copy">
       ...
       <h1 aria-label="Bad credit? No credit? We don't care."><span style={{color:"#f21f32"}}>BAD CREDIT?</span><span style={{color:"#168af4"}}>NO CREDIT?</span><span style={{color:"#fff"}}>WE DON&apos;T CARE.</span></h1>
   ...
   <section className="rh-finance" id="how-it-works"><div className="rh-finance-inner"><div className="finance-heading"><h2>IN-HOUSE FINANCING <span>MADE EASY</span></h2><p>One simple process. No hoops. No hassle.</p></div><div className="rh-steps owner-board-finance-grid">
