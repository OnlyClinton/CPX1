...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en" style={{background:"#050d14"}}><body style={{background:"#050d14"}}><WdccThreeRuntime/>{children}</body></html>}
