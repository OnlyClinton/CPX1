...
export function R31Header(){
  return <>
    ...
    <header className={styles.r31Header}>
      <div className={`wrap ${styles.headerInner}`}>
        <details className={styles.mobileMenu}>
          ...
          <nav>
            <Link href="/r31-preview/inventory">INVENTORY</Link>
        ...
        <Link className={styles.headerApply} href="/r31-preview/get-approved">GET PRE-APPROVED</Link>
    ...
    <nav className={`stickyCtaBar ${styles.mobileDock}`} aria-label="R31 quick actions">
      ...
      <Link href="/r31-preview/get-approved">GET APPROVED</Link>
