  ...
  return <div className={`li li-${phase}`} aria-label="WDCC opening intro">
    <style>{`
      ...
      .li-smoke{position:absolute;inset:-7%;z-index:3;overflow:hidden;pointer-events:none;opacity:1;background:
        ...
        animation:liAtmosphereClear 1.58s cubic-bezier(.16,.80,.24,1) .12s forwards}
      ...
      .li-smoke:before{background:
        ...
        filter:blur(18px);animation:liFogLift 1.42s cubic-bezier(.18,.72,.20,1) .08s forwards}
      .li-smoke:after{background:linear-gradient(112deg,transparent 18%,rgba(255,255,255,.08) 43%,rgba(221,233,241,.05) 51%,transparent 72%);filter:blur(11px);animation:liMistSheen 1.36s ease-out .18s forwards}
      @keyframes liAtmosphereClear{
        0%{opacity:1;backdrop-filter:blur(15px) saturate(.86) contrast(.96);-webkit-backdrop-filter:blur(15px) saturate(.86) contrast(.96)}
        34%{opacity:.86;backdrop-filter:blur(11px) saturate(.91) contrast(.98);-webkit-backdrop-filter:blur(11px) saturate(.91) contrast(.98)}
        68%{opacity:.38;backdrop-filter:blur(4px) saturate(.98) contrast(1);-webkit-backdrop-filter:blur(4px) saturate(.98) contrast(1)}
        100%{opacity:0;backdrop-filter:blur(0) saturate(1) contrast(1);-webkit-backdrop-filter:blur(0) saturate(1) contrast(1)}
      }
      @keyframes liFogLift{0%{opacity:.96;filter:blur(18px)}48%{opacity:.54;filter:blur(14px)}100%{opacity:0;filter:blur(9px)}}
      @keyframes liMistSheen{0%{opacity:.72}52%{opacity:.30}100%{opacity:0}}
      ...
      .li-tag{position:absolute;z-index:5;left:50%;top:58%;transform:translateX(-50%);margin:0;padding:7px 11px;border:1px solid rgba(255,255,255,.28);border-radius:999px;background:rgba(2,9,15,.54);backdrop-filter:blur(7px);-webkit-backdrop-filter:blur(7px);color:#fff;white-space:nowrap;font:900 clamp(13px,1.35vw,16px)/1 system-ui,sans-serif;letter-spacing:.09em;text-transform:uppercase;text-shadow:0 2px 12px rgba(0,0,0,.82);opacity:0;animation:liTagResolve .82s ease-out .42s forwards}
