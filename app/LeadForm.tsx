...
export default function LeadForm({kind,source}:{kind:Kind;source?:string}){
  ...
  async function submit(event:React.FormEvent<HTMLFormElement>){
    ...
    setBusy(true);setMessage("Saving your request…");
    try{
      ...
      const payload={
        ...
        source:leadSource,
        vehicleId:qs.get("vehicleId")||undefined,
  ...
  return <form className={`leadForm leadForm-${kind}`} onSubmit={submit}>
    ...
    <div className="leadGrid">
      ...
      <label>Email address<input name="email" type="email" autoComplete="email" maxLength={160} placeholder="you@email.com" required/></label>
