...
export function Intro(){
  ...
  return <div className={`intro-sequence intro-${phase}`} aria-label="WDCC opening animation">
    <style>{`
      ...
      .intro-scene{position:absolute!important;inset:-3%!important;z-index:0!important;background-image:linear-gradient(180deg,rgba(1,5,9,.04) 0%,rgba(1,5,9,.01) 50%,rgba(1,5,9,.26) 100%),url('/wdcc-hero-r31.webp')!important;background-size:cover!important;background-position:center 48%!important;background-repeat:no-repeat!important;transform:scale(1.035)!important;filter:saturate(1.1) contrast(1.01) brightness(1.12)!important;animation:wdccScenePush 2.95s cubic-bezier(.2,.8,.2,1) both!important}
      ...
      .intro-dock .intro-scene{filter:saturate(1.08) contrast(1.01) brightness(1.1)!important;transition:filter .8s ease!important}
