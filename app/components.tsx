...
export function Intro(){
  ...
  return <div className={`intro-sequence intro-${phase}`} aria-label="WDCC opening animation">
    <style>{`
      ...
      .intro-smoke{position:absolute!important;z-index:3!important;pointer-events:none!important;opacity:1!important;mix-blend-mode:screen!important;filter:blur(11px) saturate(.72)!important;will-change:transform,opacity!important;transform-origin:72% 62%!important}
      .intro-smoke:before,.intro-smoke:after{content:""!important;position:absolute!important;inset:-8%!important;border-radius:50%!important;pointer-events:none!important;background:
        radial-gradient(ellipse at 77% 58%,rgba(246,250,252,.92) 0 8%,rgba(211,221,226,.62) 14%,transparent 29%),
        radial-gradient(ellipse at 63% 52%,rgba(232,239,243,.74) 0 9%,rgba(160,177,185,.42) 18%,transparent 34%),
        radial-gradient(ellipse at 47% 61%,rgba(222,230,234,.64) 0 10%,rgba(137,154,164,.34) 22%,transparent 39%),
        radial-gradient(ellipse at 30% 48%,rgba(203,214,220,.52) 0 9%,rgba(118,137,148,.28) 21%,transparent 38%),
        radial-gradient(ellipse at 14% 66%,rgba(191,204,211,.42) 0 8%,rgba(102,122,134,.2) 22%,transparent 38%)!important}
      .intro-smoke:after{inset:5% -4% -10% 1%!important;opacity:.68!important;filter:blur(8px)!important;transform:translate3d(-4%,8%,0) scale(1.04,.72)!important;animation:wdccSmokeCurl .72s ease-in-out infinite alternate!important}
      .smoke-one{left:59%!important;top:57%!important;width:min(78vw,760px)!important;height:min(31vw,300px)!important;animation:wdccSmokeA 2.8s cubic-bezier(.16,.72,.2,1) both!important}
      .smoke-two{left:52%!important;top:64%!important;width:min(98vw,940px)!important;height:min(25vw,245px)!important;filter:blur(16px) saturate(.62)!important;opacity:.82!important;animation:wdccSmokeB 2.8s cubic-bezier(.16,.72,.2,1) both!important}
      .smoke-two:before{opacity:.66!important;transform:scale(1.08,.64)!important}
      .smoke-three{left:63%!important;top:58%!important;width:min(46vw,450px)!important;height:min(23vw,220px)!important;filter:blur(7px) saturate(.78)!important;animation:wdccSmokeC 2.55s cubic-bezier(.12,.72,.18,1) both!important}
      .smoke-three:before{background:
        radial-gradient(circle at 73% 60%,rgba(255,255,255,.96) 0 8%,rgba(224,231,234,.76) 13%,transparent 27%),
        radial-gradient(circle at 56% 50%,rgba(241,245,247,.82) 0 10%,rgba(174,188,195,.52) 20%,transparent 35%),
        radial-gradient(circle at 37% 64%,rgba(222,230,234,.62) 0 9%,rgba(130,149,159,.34) 22%,transparent 39%)!important}
      ...
      .intro-dock .intro-smoke{opacity:.28!important;transition:opacity .66s ease!important}
      ...
      @keyframes wdccSmokeA{0%{opacity:0;transform:translate(-34%,-43%) scale(.28,.42)}16%{opacity:.95}46%{opacity:.92;transform:translate(-54%,-53%) scale(.82,.86)}100%{opacity:.24;transform:translate(-86%,-69%) scale(1.5,1.18)}}
      @keyframes wdccSmokeB{0%{opacity:0;transform:translate(-22%,-47%) scale(.36,.28)}22%{opacity:.72}54%{opacity:.78;transform:translate(-51%,-48%) scale(.92,.64)}100%{opacity:.18;transform:translate(-82%,-51%) scale(1.56,.74)}}
      @keyframes wdccSmokeC{0%{opacity:0;transform:translate(-18%,-42%) scale(.16)}12%{opacity:1}43%{opacity:.94;transform:translate(-43%,-52%) scale(.78)}100%{opacity:.14;transform:translate(-76%,-64%) scale(1.36)}}
      @keyframes wdccSmokeCurl{0%{transform:translate3d(-2%,7%,0) scale(1.02,.7) rotate(-1deg)}100%{transform:translate3d(-7%,1%,0) scale(1.09,.82) rotate(2deg)}}
      @keyframes wdccTag{0%,24%{opacity:0;transform:translate(-50%,12px)}45%,82%{opacity:.96;transform:translate(-50%,0)}100%{opacity:.78}}
      @media(max-width:600px){.intro-scene{inset:0!important;background-size:auto 100%!important;background-position:66% center!important;transform:scale(1.01)!important;animation:wdccScenePushMobile 2.95s cubic-bezier(.2,.8,.2,1) both!important}.intro-badge{top:40%!important;width:min(62vw,290px)!important}.intro-tagline{top:67%!important;font-size:12px!important;letter-spacing:.13em!important}.smoke-one{left:63%!important;top:57%!important;width:94vw!important;height:54vw!important}.smoke-two{left:54%!important;top:65%!important;width:126vw!important;height:43vw!important}.smoke-three{left:67%!important;top:58%!important;width:62vw!important;height:39vw!important}.intro-smoke{filter:blur(9px) saturate(.72)!important}.smoke-two{filter:blur(14px) saturate(.62)!important}@keyframes wdccScenePushMobile{0%{opacity:.82;transform:scale(1.08) translate3d(3%,0,0)}100%{opacity:1;transform:scale(1.01) translate3d(0,0,0)}}}
    `}</style>
    ...
    <div className="intro-smoke smoke-three" aria-hidden="true"/>
